...
args = $"--sln={workspace}.\\FUI.sln --project=FUI.Test --output={workspace}.\\Library\\ScriptAssemblies\\FUI.Test.dll --binding={workspace}.\\Binding\\ --generated={workspace}.\\Temp\\BindingGenerated\\ --ctx_type=Attribute".Split(' ');
